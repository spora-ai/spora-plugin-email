...
#[ToolParameter(name: 'limit', type: 'integer', description: 'Maximum number of emails to retrieve (default 5, max 20). Used with read_inbox.', required: ['read_inbox'])]
...
#[ToolParameter(name: 'to', type: 'string', description: 'The email address of the recipient.', required: ['send_email'])]
